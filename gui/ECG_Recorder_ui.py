...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # sizePolicy.setHorizontalStretch(0)
        # sizePolicy.setVerticalStretch(0)
        # sizePolicy.setHeightForWidth(self.graphicsView_plot.sizePolicy().hasHeightForWidth())
        # self.graphicsView_plot.setSizePolicy(sizePolicy)
        # self.graphicsView_plot.setMinimumSize(QtCore.QSize(600, 0))
        # self.graphicsView_plot.setObjectName("graphicsView_plot")
        # self.verticalLayout_1.addWidget(self.graphicsView_plot)
