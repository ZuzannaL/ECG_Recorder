...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_ecg_measures.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:9pt;\">Average ECG <br/>measures:<br/>hr: --<br/>ibi: --<br/>sdnn: --<br/>sdsd: --<br/>rmssd: --<br/>pnn20: --<br/>pnn50: --<br/></span></p></body></html>"))
